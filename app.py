...
diabetes_model = pickle.load(open(r'diabetes_trained_model.sav', 'rb'))

heart_disease_model = pickle.load(open(r'heart_disease_trained_model.sav', 'rb'))

parkinsons_model = pickle.load(open(r'parkinsons_trained_model.sav', 'rb'))

anemia_model = pickle.load(open(r'anemia_trained_model.sav', 'rb'))
